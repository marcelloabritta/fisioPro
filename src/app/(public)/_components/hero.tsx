    ...
    <div className="container mx-auto px-4 pt-20 pb-4 sm:pb-0 sm:px-6 lg:px-8">
        ...
        <main className="flex items-center justify-center"> 
            ...
            <h1 className="text-4xl lg:text-5xl font-bold max-w-2xl tracking-tight"> 
                Encontre os melhores fisioterapeutas em um único local!
            </h1>
            <p className="text-base md:text-lg text-gray-600">
                Nós somos uma plataforma para fisioterapeutas com foco em 
                agilizar atendimento de forma simplificada e organizada 
            </p>
            <Button className="bg-blue-600 hover:bg-blue-700 w-fit px-6 font-semibold">
            ...
            <div className="hidden lg:block">
                <Image
                src={doctorImg}
                alt="Foto Ilustrativa fisioterapeuta"
                width={340}
                height={400}
