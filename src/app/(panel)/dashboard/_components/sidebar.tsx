    ...
    return (
        <div className="flex min-h-screen w-full ">
            <aside className={clsx("flex flex-col border-r bg-background transition-all duration-300 p-4 h-full", {
                ...
                <Button className="bg-gray-100 hover:bg-gray-200 text-zinc-900 self-end mb-2"
            ...
            <div className={clsx("flex flex-1 flex-col transition-all duration-300", {
                ...
                <header
                    className="md:hidden flex items-center justify-between border-b px-2 
                ...
                >
                    <Sheet>
                        ...
                        <SheetContent side="right" className="sm:max-w-xs text-black p-5">
                            <SheetTitle>FisioPRO</SheetTitle>
                            <SheetDescription>
                                Menu Administrativo
                            </SheetDescription>
...
function SidebarLink({ href, icon, isCollapsed, label, pathname }:
    ...
    return (
        ...
        >
            <div
                className={clsx("flex items-center gap-4 px-3 py-2 rounded-md transition-colors", {
